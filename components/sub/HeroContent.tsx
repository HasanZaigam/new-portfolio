...
const HeroContent = () => {
  return (
    <motion.div
      initial="hidden"
      animate="visible"
      className="flex flex-col-reverse lg:flex-row items-center justify-center px-6 sm:px-10 lg:px-20 mt-14 sm:mt-20 lg:mt-32 w-full z-[20]"
    >
      {/* Left Content */}
      <div className="h-full w-full flex flex-col gap-4 justify-center text-center lg:text-start">
        ...
        <motion.div
          variants={slideInFromLeft(0.5)}
          className="flex flex-col gap-3 mt-4 text-4xl sm:text-5xl lg:text-6xl font-bold text-white max-w-[600px] mx-auto lg:mx-0"
        >
          <span>
            I am a Full Stack{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">
        ...
        <motion.p
          variants={slideInFromLeft(0.8)}
          className="text-base sm:text-lg text-gray-400 my-3 max-w-[600px] mx-auto lg:mx-0 px-4 sm:px-0"
        >
          I have 2+ years of experience in Full Stack Development and I&apos;m
          currently learning Web3. Passionate about building high-quality web
          applications.
      ...
      <motion.div
        variants={slideInFromRight(0.8)}
        className="w-full lg:w-[500px] h-auto flex justify-center items-center relative mt-8 sm:mt-12 lg:mt-0"
      >
        {/* Outer Glow Frame */}
        <div className="relative w-[180px] sm:w-[260px] md:w-[280px] lg:w-[330px] h-auto rounded-full border-4 border-transparent bg-gradient-to-r from-purple-500 to-cyan-500 p-1">
          <div className="w-full h-full rounded-full bg-[#060606] flex justify-center items-center overflow-hidden">
            {/* Profile Image */}
            <Image
              src="/DGWFjmty_400x400.jpg"
